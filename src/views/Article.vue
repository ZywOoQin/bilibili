        ...
        <div class="detailinfo">
            ...
            <div class="detailinfoText">
                ...
                <div class="detailparent">
                    <home-detail class="detailitem" v-for="(item,index) in commendList" :key="index"  :detailitem="item"></home-detail>
                </div>
            </div>
...
<script>
    ...
    import HomeDetail from '@/components/common/HomeDetail.vue'
...
<style lang='less' scoped>
    .detailinfo{
        ...
        .detailinfoText{
            ...
            >div:nth-child(3) {
                padding: 0 2.778vw 1.389vw 2.778vw;
                display: flex;
                p{
                    margin-right: 10px;
                    display: flex;
